...
const page = () => {
  return (
    <div className="animate-in fade-in duration-1000">
      <section className="pt-32 bg-white relative overflow-hidden">
        <div className="relative h-[60vh] overflow-hidden">
          <Image
            ...
            className="object-cover z-1 md:rounded-b-[75%]"
          />
          <div className="absolute inset-0 bg-slate-800/40 z-1 md:rounded-b-[75%]"></div>
          <div className="z-1 h-full text-white md:p-10 p-5 relative flex justify-center items-center  text-center">
            {/*<div className="container mx-auto px-6  relative z-10"> */}
            <h1 className="text-2xl text-white md:text-6xl font-black mb-8 tracking-tight">
              Enterprise Solutions.{" "}
              <span className="text-emerald-400">Personal Touch.</span>
            </h1>

            {/* <p className=" md:w-[50%] font-semibold text-left  text-white max-w-4xl  leading-relaxed">
              Our enterprise-grade medical billing services combine revenue
              cycle management software, medical coding services, and hands-on
              expertise to maximize profitability across the entire care
              continuum from patient intake to final payment posting.
              <br />
              Apollo supports practices using EHR systems, EMR software,
              practice management software, and patient management systems,
              delivering scalable RCM services for both small practices in USA
              and high-volume enterprise clinics in California.
            </p> */}
          </div>
        </div>
      </section>

      <section className="mt-24 md:mt-32 bg-white">
